package com.example.fartosandroid.Pantallas;
...
import com.example.fartosandroid.DialogFragCard;
import com.example.fartosandroid.MLayout.ScaleCenterItemLayoutManager;
...
import com.example.fartosandroid.interfaces.SelectListenerCarta;
...
public class MainActivity extends AppCompatActivity implements SelectListenerCarta {
  ...
  public void initJugadors() {
    players.add(new Jugador("Erica", R.drawable.eni, R.drawable.erica));
    players.add(new Jugador("Mario Bros", R.drawable.mario, R.drawable.mariocara));
    players.add(new Jugador("Marco", R.drawable.marco, R.drawable.iconmar));
  }
  ...
  public void initMap() {
    ...
    move(players.get(2), 3);
    move(players.get(0), 2);
